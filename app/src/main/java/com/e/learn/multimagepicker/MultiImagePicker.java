...
public class MultiImagePicker extends AppCompatActivity {
                    ...
                    if (resultData.getClipData() != null) {
                        ...
                        while (currentItem < count) {
                            ...
                            try {
                                ...
                                MyAdapter mAdapter = new MyAdapter(MultiImagePicker.this, arrayList);
            ...
            call.enqueue(new Callback<ResponseBody>() {
                ...
                public void onResponse(@NonNull Call<ResponseBody> call, @NonNull Response<ResponseBody> response) {
                    ...
                    if(response.isSuccessful()) {
                        Toast.makeText(MultiImagePicker.this,
        ...
        if ((ContextCompat.checkSelfPermission(this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                ...
                Snackbar.make(this.findViewById(android.R.id.content),
                        ...
                        v -> ActivityCompat.requestPermissions(MultiImagePicker.this,
                                new String[]{Manifest.permission.READ_EXTERNAL_STORAGE,
                                        Manifest.permission.WRITE_EXTERNAL_STORAGE},
                                REQUEST_CODE_PERMISSIONS)).show();
            } else {
                /* Request for permission */
                ActivityCompat.requestPermissions(MultiImagePicker.this,
                        new String[]{Manifest.permission.READ_EXTERNAL_STORAGE,
                                Manifest.permission.WRITE_EXTERNAL_STORAGE},
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == REQUEST_CODE_PERMISSIONS) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                // Permission Denied
                Toast.makeText(MultiImagePicker.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
            }
        } else {
    ...
    private void showMessageOKCancel(DialogInterface.OnClickListener okListener) {
        AlertDialog.Builder builder = new AlertDialog.Builder(MultiImagePicker.this);
        ...
        dialog.setOnShowListener(arg0 -> {
            dialog.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(
                    ContextCompat.getColor(MultiImagePicker.this, android.R.color.holo_blue_light));
            dialog.getButton(AlertDialog.BUTTON_NEGATIVE).setTextColor(
                    ContextCompat.getColor(MultiImagePicker.this, android.R.color.holo_red_light));
        });
